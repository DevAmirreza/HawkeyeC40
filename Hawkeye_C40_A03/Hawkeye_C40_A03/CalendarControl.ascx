...
<input name="txtDatePicker" runat="server" id="txtDate" class="form-control datepicker"  /><asp:ImageButton ID="btnStartDate" runat="server" Height="25px" Width="25px" OnClick="btnStartDate_Click" ImageUrl="~/images/Calendar.png" CssClass="calButtons" CausesValidation="False" />
